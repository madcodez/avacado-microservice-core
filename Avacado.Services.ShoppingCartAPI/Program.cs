using AutoMapper;
using Avacado.Services.ShoppingCartAPI.Extensions;
using Avacado.Services.ShoppingCartAPI;
...
builder.Services.AddHttpClient("Coupon", u => u.BaseAddress = new Uri(builder.Configuration["ServiceUrls:CouponAPI"])).AddHttpMessageHandler<BackendAPIAuthenticator>();
